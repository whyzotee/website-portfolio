...
export default function Experience() {
  return (
    <div className="w-full flex flex-col gap-12 items-center justify-center bg-[#1f1f1f] p-24">
      <h1 className="text-6xl font-semibold text-white">ประสบการณ์</h1>
      <div className="flex w-full flex-col items-center">
        <Tabs aria-label="Options" className="text-3xl">
            ...
            >
              ...
              >
                <div className="flex items-center justify-between">
                  <div className="w-full pr-4 flex flex-col gap-4">
                    <p>
                      &emsp;ช่วงศึกษาต่อในสาขาคอมพิวเตอร์ระบบเครือข่าย ระดับชั้น
                      ปวส. เกรดเฉลี่ยสะสมทั้งหมด 4 ภาคเรียน รวมฝึกงาน (GPAX)
                      อยู่ที่ 3.51 ครับ
