      ...
      <div className="max-w-7xl w-full py-12 z-20">
        <div className="flex flex-col items-end text-white">
          <h1 className="text-6xl font-semibold">
            ทำไม? ถึงอยากเข้า<span className="text-[#F16322]"> สจล. </span>
          </h1>
          <div className="text-xl self-center mt-24">
            <p>
              ...
              ผมนั้นสนใจที่จะศึกษาต่อในระดับปริญญาตรี
              เลยเลือกเรียนต่อสถาบันที่ดีที่สุดนั่นเอง
            </p>
            <br />
            <p>
              &emsp;ด้วยปัจจัยหลายๆด้าน เช่น ย้ายมาเรียนที่กรุงเทพฯนั้น
              เพื่อจะได้อยู่ใกล้คุณแม่ที่ทำงานอยู่ภายในกรุงเทพฯ,
              เรียนอย่างต่อเนื่อง
              ในประเทศไทยนั้นน้อยมากที่มหาวิทยาลัยส่วนใหญ่ภายในประเทศจะมีหลักสูตรสำหรับคนที่จบ
              ประกาศนียบัตรวิชาชีพชั้นสูง
              เลยทำให้บางคนต้องเรียนระดับปริญญาตรีใหม่ 4ปี
            ...
            <p>
              ...
              อิเล็กทรอนิกส์ เพราะรู้สึกเหมือนเป็นการพิสูจน์ความรู้ตัวเอง
              และสนุกกับการแข่งขัน
            </p>
          </div>
        </div>
